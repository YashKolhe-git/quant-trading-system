...
class ListCommand(IndexGroupCommand):
    ...
    def add_options(self) -> None:
        ...
        selection_opts = cmdoptions.make_option_group(
            cmdoptions.package_selection_group, self.parser,
        )
    ...
    def _build_package_finder(
        ...
        selection_prefs = SelectionPreferences(
            allow_yanked=False, release_control=options.release_control,
        )
    ...
    def iter_packages_latest_infos(
        ...
        with self._build_session(options) as session:
            ...
            def latest_info(dist: _DistWithLatestInfo,) -> _DistWithLatestInfo | None:
